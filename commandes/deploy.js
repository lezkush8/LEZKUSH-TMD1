...
✔First type the sc ,repo or script command and you will get lezkush repository 
✔From there you are required to get your *Session id* but how,??..
         𝐇𝐎𝐖 𝐓𝐎 𝐆𝐄𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐈𝐃
✞ Open this link 👉 https://lezkush-session-id.onrender.com/pair   then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  +968 78856800 then tap submit 
✞kezkush owner , *lezkush* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that lezkush owner sent you.
✞ After a successful login lezkush owner 🤔 lezkush will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 *LEZKUSH TMD*
...
✔Now click on this devs number and give LEZKUSH owner credits https://wa.me/968 78856800
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 dev team TimnasaTech & *Lezkush*`;
   var lien = mybotpic();
