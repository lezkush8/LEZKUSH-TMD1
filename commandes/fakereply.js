...
hango({ nomCom: "fakereply2", alias: ["freply"], categorie: "Tools" }, async (dest, hn, commandeOptions) => {
    ...
    if (type.toLowerCase() === "text") {
        ...
        try {
            let ppUrl = await hn.profilePictureUrl(num + "@s.whatsapp.net").catch(() => "https://i.imgur.com/rSba5p5.png");
    ...
    try {
        await hn.sendMessage(dest, { text: reply }, { quoted: fak });
